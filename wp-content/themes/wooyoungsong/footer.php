<footer class="footer">
        <div class="contact">
            <a class="email" href="mailto:ws392@drexel.edu">ws392@drexel.edu</a>
            <div class="social">
                <a target="_blank" href="https://www.linkedin.com/in/wooyoung-song-661345136/">
                    <svg class="linkedin-icon icon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                <a target="_blank" href="https://github.com/wwwApp/">
                    <svg class="github-icon icon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        x="0px" y="0px" width="438.536px" height="438.536px" viewBox="0 0 438.536 438.536" style="enable-background:new 0 0 438.536 438.536;"
                        xml:space="preserve">
                        <g>
                            <g>
